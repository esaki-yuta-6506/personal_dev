...
public class AccountController {
	...
	public String store(
		...
		customer = new Customer(3, name, address, tel, email, password);
	...
	public String sendAccount(
		...
		customer = new Customer(id, customer.getModeId(), name, address, tel, email, password);
		customerRepository.save(customer);
